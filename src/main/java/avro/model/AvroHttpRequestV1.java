...
public class AvroHttpRequestV1 extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 5213169242644831164L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"AvroHttpRequestV1\",\"namespace\":\"avro.model\",\"fields\":[{\"name\":\"requestTime\",\"type\":\"int\"},{\"name\":\"clientIdentifier\",\"type\":{\"type\":\"record\",\"name\":\"ClientIdentifier\",\"fields\":[{\"name\":\"hostName\",\"type\":\"string\"},{\"name\":\"ipAddress\",\"type\":\"string\"}]}},{\"name\":\"employeeNames\",\"type\":{\"type\":\"array\",\"items\":\"string\"},\"default\":[]},{\"name\":\"active\",\"type\":{\"type\":\"enum\",\"name\":\"Active\",\"symbols\":[\"YES\",\"NO\"]}}]}");
  public static org.apache.avro.Schema getClassSchema() { return SCHEMA$; }

  private static SpecificData MODEL$ = new SpecificData();

  private static final BinaryMessageEncoder<AvroHttpRequestV1> ENCODER =
      new BinaryMessageEncoder<AvroHttpRequestV1>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<AvroHttpRequestV1> DECODER =
      new BinaryMessageDecoder<AvroHttpRequestV1>(MODEL$, SCHEMA$);

  /**
   * Return the BinaryMessageEncoder instance used by this class.
   * @return the message encoder used by this class
   */
  public static BinaryMessageEncoder<AvroHttpRequestV1> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<AvroHttpRequestV1> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<AvroHttpRequestV1> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<AvroHttpRequestV1>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this AvroHttpRequestV1 to a ByteBuffer.
  ...
  /**
   * Deserializes a AvroHttpRequestV1 from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a AvroHttpRequestV1 instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static AvroHttpRequestV1 fromByteBuffer(
   ...
   */
  public AvroHttpRequestV1(java.lang.Integer requestTime, avro.model.ClientIdentifier clientIdentifier, java.util.List<java.lang.CharSequence> employeeNames, avro.model.Active active) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: requestTime = (java.lang.Integer)value$; break;
  ...
  /**
   * Creates a new AvroHttpRequestV1 RecordBuilder.
   * @return A new AvroHttpRequestV1 RecordBuilder
   */
  public static avro.model.AvroHttpRequestV1.Builder newBuilder() {
    return new avro.model.AvroHttpRequestV1.Builder();
  }

  /**
   * Creates a new AvroHttpRequestV1 RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new AvroHttpRequestV1 RecordBuilder
   */
  public static avro.model.AvroHttpRequestV1.Builder newBuilder(avro.model.AvroHttpRequestV1.Builder other) {
    if (other == null) {
      return new avro.model.AvroHttpRequestV1.Builder();
    } else {
      return new avro.model.AvroHttpRequestV1.Builder(other);
    }
  }

  /**
   * Creates a new AvroHttpRequestV1 RecordBuilder by copying an existing AvroHttpRequestV1 instance.
   * @param other The existing instance to copy.
   * @return A new AvroHttpRequestV1 RecordBuilder
   */
  public static avro.model.AvroHttpRequestV1.Builder newBuilder(avro.model.AvroHttpRequestV1 other) {
    if (other == null) {
      return new avro.model.AvroHttpRequestV1.Builder();
    } else {
      return new avro.model.AvroHttpRequestV1.Builder(other);
  ...
  /**
   * RecordBuilder for AvroHttpRequestV1 instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvroHttpRequestV1>
    implements org.apache.avro.data.RecordBuilder<AvroHttpRequestV1> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(avro.model.AvroHttpRequestV1.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing AvroHttpRequestV1 instance
     * @param other The existing instance to copy.
     */
    private Builder(avro.model.AvroHttpRequestV1 other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.requestTime)) {
        this.requestTime = data().deepCopy(fields()[0].schema(), other.requestTime);
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.model.AvroHttpRequestV1.Builder setRequestTime(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.model.AvroHttpRequestV1.Builder clearRequestTime() {
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.model.AvroHttpRequestV1.Builder setClientIdentifier(avro.model.ClientIdentifier value) {
     ...
     * @return This builder.
     */
    public avro.model.AvroHttpRequestV1.Builder setClientIdentifierBuilder(avro.model.ClientIdentifier.Builder value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.model.AvroHttpRequestV1.Builder clearClientIdentifier() {
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.model.AvroHttpRequestV1.Builder setEmployeeNames(java.util.List<java.lang.CharSequence> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.model.AvroHttpRequestV1.Builder clearEmployeeNames() {
      employeeNames = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.model.AvroHttpRequestV1.Builder setActive(avro.model.Active value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.model.AvroHttpRequestV1.Builder clearActive() {
      active = null;
    ...
    public AvroHttpRequestV1 build() {
      try {
        AvroHttpRequestV1 record = new AvroHttpRequestV1();
        record.requestTime = fieldSetFlags()[0] ? this.requestTime : (java.lang.Integer) defaultValue(fields()[0]);
        if (clientIdentifierBuilder != null) {
          try {
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<AvroHttpRequestV1>
    WRITER$ = (org.apache.avro.io.DatumWriter<AvroHttpRequestV1>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<AvroHttpRequestV1>
    READER$ = (org.apache.avro.io.DatumReader<AvroHttpRequestV1>)MODEL$.createDatumReader(SCHEMA$);
